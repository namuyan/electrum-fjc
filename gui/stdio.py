...
class ElectrumGui:
    ...
    def __init__(self, config, daemon, plugins):
        ...
        if not storage.file_exists:
            print "Wallet not found. try 'electrum-fjc create'"
            exit()
    ...
    def network_dialog(self):
        print("use 'electrum-fjc setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'electrum-fjc setconfig' to change your settings")
        return True
