...
;Variables
  ...
  !define PRODUCT_WEB_SITE "https://github.com/namuyan/electrum-fjc"
...
Section
  ...
  WriteRegStr HKCU "Software\Classes\litecoin\shell\open\command" "" "$\"$INSTDIR\electrum-fjc-${PRODUCT_VERSION}.exe$\" $\"%1$\""
